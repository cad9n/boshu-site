...
//
$mail_sys = "info@bs-precut.co.jp";	// 管理者のメールアドレス
$from_name = "防秋産業株式会社";	// メール送信者の表示
$from_mail = "info@precut.co.jp";	// メール送信者のメールアドレス（返信先）
...
$footer = "\n----------------------------
防秋産業株式会社
http://www.bs-precut.co.jp/
Mail:info@bs-precut.co.jp
----------------------------
";
//------------------------------------------------
